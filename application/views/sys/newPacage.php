 ...
 <div class="container col-10 mb-5">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Name" id="email" required name="sender_name">
    <?php echo form_error('sender_name', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
  <div class="form-group mt-3">
      <h5>Address</h5>
    <label for="pwd">Street Address </label>
    <input type="text" class="form-control" placeholder="Street Address" id="pwd" name="sender_street" required>
     <?php echo form_error('sender_street', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">City / Town </label>
    <input type="text" class="form-control" placeholder="City / Town" id="pwd" name="sender_city" required>
     <?php echo form_error('sender_city', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">State / Province</label>
    <input type="text" class="form-control" placeholder="State / Province" id="pwd" name="sender_state" required>
     <?php echo form_error('sender_state', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">Zip / Postal</label>    
    <input type="text" class="form-control" placeholder="Zip / Postal" id="pwd" name="sender_zip" required>
     <?php echo form_error('sender_zip', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">Country</label>
     <input type="text" class="form-control" placeholder="Country" id="pwd" name="sender_country" required>
      <?php echo form_error('sender_country', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
  </div>
         
   <div class="form-group">
    <label for="email">Email</label>
    <input type="email" class="form-control" placeholder="Sender Email" id="email" required name="sender_mail" required>
     <?php echo form_error('sender_mail', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
     
     <div class="form-group">
    <label for="email">Contact Number</label>
    <input type="text" class="form-control" placeholder="Contact Number" id="email" required name="sender_contact" required>
     <?php echo form_error('sender_contact', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
  
    <div class="form-group">
    <label for="email">NIC</label>
    <input type="text" class="form-control" placeholder="National Identity Number" id="email" required name="sender_nic" required>
  ...
  <div class="form-group">
    <label for="email">Name</label>
    <input type="text" class="form-control" placeholder="Name" id="email" required  name="receiver_name">
    <?php echo form_error('receiver_name', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
  <div class="form-group mt-3">
      <h5>Address</h5>
    <label for="pwd">Street Address </label>
    <input type="text" class="form-control" placeholder="Street Address" id="pwd" name="receiver_street" required> 
    <?php echo form_error('receiver_street', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">City / Town </label>
    <input type="text" class="form-control" placeholder="City / Town" id="pwd" name="receiver_city" required>
    <?php echo form_error('receiver_city', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">State / Province</label>
    <input type="text" class="form-control" placeholder="State / Province" id="pwd" name="receiver_state" required>
    <?php echo form_error('receiver_state', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">Zip / Postal</label>    
    <input type="text" class="form-control" placeholder="Zip / Postal" id="pwd" name="receiver_zip" required>
    <?php echo form_error('receiver_zip', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
    <label for="pwd">Country</label>
    <input type="text" class="form-control" placeholder="Country" id="pwd" name="receiver_country" required>
    <?php echo form_error('receiver_country', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?></br>
  </div>
         
   <div class="form-group">
    <label for="email">Email</label>
    <input type="email" class="form-control" placeholder="Email" id="email" required name="receiver_mail">
    <?php echo form_error('receiver_mail', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
     
      <div class="form-group">
    <label for="email">Contact Number</label>
    <input type="text" class="form-control" placeholder="Contact Number" id="email" required name="receiver_contact">
    <?php echo form_error('receiver_contact', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
  </div>
  
    <div class="form-group">
    <label for="email">NIC</label>
    <input type="text" class="form-control" placeholder="National Identity Number" id="email" required name="receiver_nic">
    ...
    <input type="text" class="form-control" placeholder="Package Weight" id="email" required style="width:150px" name="package_weight">
     <?php echo form_error('package_weight', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
     </div>
     
     <div class="form-group">
    <label for="email">Package Category </label>
    <input type="text" class="form-control" placeholder="Package Category" id="email" required style="width:150px" name="package_category">
    ...
    <input type="date" class="form-control" placeholder="Package Category" id="date_deliver" required style="width:300px" onchange="calDate()" name="package_date_finish">
    ...
    <input type="hidden" class="form-control"  id="totay" required style="width:300px"   value="<?php echo date('Y-m-d')?>" readonly >
    <input type="text" class="form-control"  id="da" required style="width:300px"  readonly name="package_date_to_recive">
     <?php echo form_error('package_date_to_recive', '<div class="alert text-danger"><strong>* </strong>', '</div> '); ?>
    </div>
     
    <div class="form-group">
    <label for="email">Note</label>
    <textarea class="form-control" name="package_note"></textarea>
    
    
     <div class="form-group">
    <label for="email">Cost of Delivery <?php echo $this->db->get_where('system_details', array('id' => '1'))->row()->currency ?></label>
    
    <input type="text" class="form-control"  placeholder="" id="da" required style="width:300px"   name="delivery_cost" required>
